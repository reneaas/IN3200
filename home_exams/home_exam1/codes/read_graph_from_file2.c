...
/*
Reads webgraph from file and stores it in CRS-format.

char *filename: pointer to filename

int *N: pointer to number of nodes in the webgraph.

int *N_links: pointer to number of edges in the webgraph

int **row_ptr: row_pointer of length N+1. Is of the form r = (0, r0, r0 + r1, ..., r0 + r1 + ... rN-1)

int **col_idx: pointer that stores indices of column elements.
*/
