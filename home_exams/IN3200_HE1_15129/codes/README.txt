...
#### Important note!
The parallelized version of the codes use an OpenMP version is dependent on a gcc compiler that use OpenMP 4.5 or newer since
it uses array reductions which is a feature that came with OpenMP 4.5.
